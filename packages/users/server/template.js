...
module.exports = {
  ...
  welcome_email: function(user, req, token, mailOptions) {
    mailOptions.html = [
      'Hi ' + user.name + ',',
      'Welcome to Mesh, a community of individuals that acknowledge their need for others in acheiving goals.'
    ].join('\n\n');
    mailOptions.subject = 'Welcome to Mesh';
    return mailOptions;
  }
};
